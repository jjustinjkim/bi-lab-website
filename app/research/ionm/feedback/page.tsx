      ...
      {available ? (
        ...
        <div className="panel p-6 text-sm">
          <p className="font-medium mb-2" style={{ color: "var(--ink)" }}>
            This form isn&rsquo;t available right now.
          </p>
          <p style={{ color: "var(--ink-muted)" }}>
            The linked form has been removed or is no longer accessible. Contact the lab directly if you&rsquo;d like to share feedback some other way.
          </p>
        </div>
      )}
    </div>
