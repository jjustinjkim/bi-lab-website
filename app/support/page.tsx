    ...
    <div>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-14 space-y-6">
        ...
        <p className="text-lg" style={{ color: "var(--ink-muted)" }}>
          We are grateful for the general support and funding to the Bi Lab, to help accelerate our studies on
          skull base and brain tumors, including meningiomas, pituitary tumors, gliomas, brain mets, and
          epidermoid cysts. Together, we aim to translate these findings into better outcomes for our patients.
        </p>
