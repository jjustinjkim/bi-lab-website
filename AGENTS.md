...
Public marketing site (Home/Research/Team/Publications/Contact) for Dr. Wenya Linda Bi's lab, plus a login-gated `/portal` area (project manager tool: projects, grants) for lab members only.
